        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">List Skills</h3>
                </div>
                <div class="card-toolbar">
                    <a href="{{ url('admin-cms/skills/create') }}" class="btn btn-primary font-weight-bold"><i class="flaticon2-plus"></i> Create</a>
                </div>
            </div>
            <div class="card-body">
...
<script>
    $(document).ready(function(){
        ...
        table.DataTable({
            ...
            responsive: true,
			ajax: {
				url: "{{ url('admin-cms/skills/datatable') }}",
				type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}"
                }
        ...
        $(document).on('change', '.btn-activate', function(e){
            ...
            $.ajax({
                url: "{{ url('admin-cms/skills/change-status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
                    _method: 'put',
